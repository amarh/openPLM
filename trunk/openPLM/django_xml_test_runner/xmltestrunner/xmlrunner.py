...
# Added output_name and output_dir parameter to XMLTestRunner constructor.
# Eric Palakovich Carr
# 3/14/10
#
# Removed output_name.  _XMLTestResult object is now created outside of
# XMLTestRunner and passed into the constructor.
# 5/24/10
...
class _XMLTestResult(unittest.TestResult):
    ...
    def set_test_name(self, value):
        self._test_name = value
    def del_test_name(self):
        del self._test_name
    test_name = property(get_test_name, set_test_name, del_test_name, "test_name")
...
class XMLTestRunner(object):
    ...
    results are stored in a file called <output_name>.xml in
    output_dir (or the current working directory by default).  If
    output_name isn't provided, the file will be called TEST-<module>.<class>,
    where <module> and <class> are the module and class name of the test class.

    """

    def __init__(self, result, output_name=None, output_dir=None, stream=None):
        self.result = result
        self._stream = stream
