...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Document3D.step_active'
        db.add_column('document3D_document3d', 'step_active', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='step_active', to=orm['plmapp.DocumentFile']), keep_default=False)

        # Adding field 'Document3D.step_decompose'
        db.add_column('document3D_document3d', 'step_decompose', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='step_decompose', to=orm['plmapp.DocumentFile']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Document3D.step_active'
        db.delete_column('document3D_document3d', 'step_active_id')

        # Deleting field 'Document3D.step_decompose'
        db.delete_column('document3D_document3d', 'step_decompose_id')
    ...
    models = {
        ...
        'document3D.document3d': {
            ...
            'step_active': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'step_active'", 'to': "orm['plmapp.DocumentFile']"}),
            'step_decompose': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'step_decompose'", 'to': "orm['plmapp.DocumentFile']"})
        },
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 22, 14, 31, 50, 683688)'}),
        ...
        'plmapp.plmobject': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 22, 14, 31, 50, 682123)'}),
