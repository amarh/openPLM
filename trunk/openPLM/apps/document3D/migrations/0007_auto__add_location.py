...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'document3D.location': {
            'Meta': {'object_name': 'Location', '_ormbases': ['plmapp.ParentChildLinkExtension']},
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 31, 10, 32, 2, 897948)'}),
        ...
        'plmapp.plmobject': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 31, 10, 32, 2, 900809)'}),
