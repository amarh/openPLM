...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'document3D.step_original': {
            'Meta': {'object_name': 'step_original'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 7, 13, 52, 41, 754083)'}),
        ...
        'plmapp.plmobject': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 7, 13, 52, 41, 756661)'}),
