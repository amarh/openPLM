...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Document3D.step_original'
        db.alter_column('document3D_document3d', 'step_original_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['plmapp.DocumentFile']))


    def backwards(self, orm):
        
        # Changing field 'Document3D.step_original'
        db.alter_column('document3D_document3d', 'step_original_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['plmapp.DocumentFile'], null=True))
    ...
    models = {
        ...
        'document3D.document3d': {
            ...
            'step_original': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plmapp.DocumentFile']"})
        },
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 7, 12, 4, 46, 953952)'}),
        ...
        'plmapp.plmobject': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 7, 12, 4, 46, 962166)'}),
