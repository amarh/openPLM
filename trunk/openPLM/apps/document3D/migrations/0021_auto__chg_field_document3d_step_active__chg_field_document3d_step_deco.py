...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Document3D.step_active'
        db.alter_column('document3D_document3d', 'step_active_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['plmapp.DocumentFile']))

        # Changing field 'Document3D.step_decompose'
        db.alter_column('document3D_document3d', 'step_decompose_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['plmapp.DocumentFile']))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Document3D.step_active'
        raise RuntimeError("Cannot reverse this migration. 'Document3D.step_active' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Document3D.step_decompose'
        raise RuntimeError("Cannot reverse this migration. 'Document3D.step_decompose' and its values cannot be restored.")
    ...
    models = {
        ...
        'document3D.document3d': {
            ...
            'step_active': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'step_active'", 'null': 'True', 'to': "orm['plmapp.DocumentFile']"}),
            'step_decompose': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'step_decompose'", 'null': 'True', 'to': "orm['plmapp.DocumentFile']"})
        },
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 22, 14, 33, 25, 192116)'}),
        ...
        'plmapp.plmobject': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 22, 14, 33, 25, 188908)'}),
