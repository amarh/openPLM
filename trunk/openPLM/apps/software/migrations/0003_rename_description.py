...
class Migration(SchemaMigration):
    ...
    needed_by = (
        ("plmapp", "0032_auto__add_field_plmobject_description"),
    )


    def forwards(self, orm):
        db.rename_column("software_package", "description", "description2")
        db.rename_column("software_software", "description", "description2")

    def backwards(self, orm):
        db.rename_column("software_package", "description2", "description")
        db.rename_column("software_software", "description2", "description")
