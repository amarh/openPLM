...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Page'
        db.create_table(u'richpage_page', (
            (u'document_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['plmapp.Document'], unique=True, primary_key=True)),
            ('page_content', self.gf('django.db.models.fields.TextField')(default='Edit me')),
        ))
        db.send_create_signal(u'richpage', ['Page'])


    def backwards(self, orm):
        # Deleting model 'Page'
        db.delete_table(u'richpage_page')
    ...
    models = {
        ...
        u'richpage.page': {
            'Meta': {'ordering': "['type', 'reference', 'revision']", 'object_name': 'Page', '_ormbases': ['plmapp.Document']},
            u'document_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['plmapp.Document']", 'unique': 'True', 'primary_key': 'True'}),
            'page_content': ('django.db.models.fields.TextField', [], {'default': "'Edit me'"})
        }
    }

    complete_apps = ['richpage']