...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OERPProduct'
        db.create_table('oerp_oerpproduct', (
        ...
        db.send_create_signal('oerp', ['OERPProduct'])

        # Adding model 'OERPBOM'
        db.create_table('oerp_oerpbom', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('link', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['plmapp.ParentChildLink'], unique=True)),
            ('bom', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('oerp', ['OERPBOM'])


    def backwards(self, orm):
        
        # Deleting model 'OERPProduct'
        db.delete_table('oerp_oerpproduct')

        # Deleting model 'OERPBOM'
        db.delete_table('oerp_oerpbom')
    ...
    models = {
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 4, 16, 29, 50, 960976)'}),
        ...
        'plmapp.plmobject': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 4, 16, 29, 50, 964977)'}),
