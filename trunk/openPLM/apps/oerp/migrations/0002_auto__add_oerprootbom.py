...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OERPRootBOM'
        db.create_table('oerp_oerprootbom', (
        ...
        db.send_create_signal('oerp', ['OERPRootBOM'])


    def backwards(self, orm):
        
        # Deleting model 'OERPRootBOM'
        db.delete_table('oerp_oerprootbom')
    ...
    models = {
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 7, 15, 3, 12, 915602)'}),
        ...
        'plmapp.plmobject': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 7, 15, 3, 12, 907602)'}),
