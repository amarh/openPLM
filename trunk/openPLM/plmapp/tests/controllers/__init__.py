from openPLM.plmapp.tests.controllers.base import *
...
from openPLM.plmapp.tests.controllers.deletion import *
from openPLM.plmapp.tests.controllers.group import *
from openPLM.plmapp.tests.controllers.partdoc import *
