...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lifecycle.type'
        db.add_column('plmapp_lifecycle', 'type',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lifecycle.type'
        db.delete_column('plmapp_lifecycle', 'type')
    ...
    models = {
        ...
        'plmapp.invitation': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'7605991049572483061815056325067620245166270184826771383481263537288120847960567095324024350060476098800899609427215033242710140276902591948821940309932550'", 'max_length': '155', 'primary_key': 'True'}),
        ...
        'plmapp.statehistory': {
            ...
            'lifecycle': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plmapp.Lifecycle']"}),
            'plmobject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plmapp.PLMObject']"}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 13, 0, 0)'}),
            'state': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plmapp.State']"}),
