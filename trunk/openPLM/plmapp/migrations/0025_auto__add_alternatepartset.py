...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AlternatePartSet'
        db.create_table('plmapp_alternatepartset', (
        ...
        db.send_create_signal('plmapp', ['AlternatePartSet'])

        # Adding M2M table for field parts on 'AlternatePartSet'
        db.create_table('plmapp_alternatepartset_parts', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('alternatepartset', models.ForeignKey(orm['plmapp.alternatepartset'], null=False)),
            ('part', models.ForeignKey(orm['plmapp.part'], null=False))
        ))
        db.create_unique('plmapp_alternatepartset_parts', ['alternatepartset_id', 'part_id'])


    def backwards(self, orm):
        # Deleting model 'AlternatePartSet'
        db.delete_table('plmapp_alternatepartset')

        # Removing M2M table for field parts on 'AlternatePartSet'
        db.delete_table('plmapp_alternatepartset_parts')
    ...
    models = {
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 23, 0, 0)'}),
        ...
        'plmapp.invitation': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'2357161587656883390082986248637549151966467597237227107971294647387924464133656758960519916537329090313892516108092035971880601821699860706338997727830226'", 'max_length': '155', 'primary_key': 'True'}),
        ...
        'plmapp.statehistory': {
            ...
            'lifecycle': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plmapp.Lifecycle']"}),
            'plmobject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plmapp.PLMObject']"}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 23, 0, 0)'}),
            'state': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plmapp.State']"}),
