...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DocumentFile.deprecated'
        db.add_column('plmapp_documentfile', 'deprecated', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DocumentFile.deprecated'
        db.delete_column('plmapp_documentfile', 'deprecated')
    ...
    models = {
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 23, 10, 17, 1, 567901)'}),
        ...
        'plmapp.invitation': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 23, 10, 17, 1, 571478)'}),
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'9285814554974193432737341263064178289036440062680930819469618519295078923989621475564919714953230668315440526231206124761880144512848088691311189303189574'", 'max_length': '155', 'primary_key': 'True'}),
        ...
        'plmapp.plmobject': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 23, 10, 17, 1, 570387)'}),
