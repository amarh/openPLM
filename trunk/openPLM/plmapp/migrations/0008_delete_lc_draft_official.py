...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """ Replace draft_official lifecycle on plmobjects with 
        draft_official_deprecated lifecycle
        ...
        try:
            ...
            draft_official_deprecated = orm.Lifecycle.objects.get(name="draft_official_deprecated")
            orm.PLMObject.objects.filter(lifecycle=draft_official).update(lifecycle=draft_official_deprecated)
            draft_official.delete()
    ...
    models = {
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 14, 14, 59, 56, 260895)'}),
        ...
        'plmapp.invitation': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 14, 14, 59, 56, 267275)'}),
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'363814777645390606428346862876073629060806691109961424532011553937876513078120964916273349790585322763090430656554967152769274322532611083754438934079188'", 'max_length': '155', 'primary_key': 'True'}),
        ...
        'plmapp.plmobject': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 14, 14, 59, 56, 257583)'}),
