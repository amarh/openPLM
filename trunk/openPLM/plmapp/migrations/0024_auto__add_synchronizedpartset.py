...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('plmapp_synchronizedpartset', (
        ...
        db.create_table('plmapp_synchronizedpartset_parts', (
        ...
        db.create_unique('plmapp_synchronizedpartset_parts', ['synchronizedpartset_id', 'part_id'])


    def backwards(self, orm):
        # Deleting model 'SynchronizedPartSet'
        db.delete_table('plmapp_synchronizedpartset')
    ...
    models = {
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 12, 0, 0)'}),
        ...
        'plmapp.invitation': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'2388488905502785298845428367935817504970283380659773483707339127820440146101956228862989158880053610323762934958068289321066551375234846744120358596198936'", 'max_length': '155', 'primary_key': 'True'}),
        ...
        'plmapp.statehistory': {
            ...
            'lifecycle': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plmapp.Lifecycle']"}),
            'plmobject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plmapp.PLMObject']"}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 12, 0, 0)'}),
            'state': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plmapp.State']"}),
