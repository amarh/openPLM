...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('plmapp_statehistory', (
            ...
            ('start_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 3, 19, 14, 38, 0, 43104))),
            ('end_time', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('state_category', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
        ))
        db.send_create_signal('plmapp', ['StateHistory'])


    def backwards(self, orm):
        
        # Deleting model 'StateHistory'
        db.delete_table('plmapp_statehistory')
    ...
    models = {
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 19, 14, 38, 0, 226426)'}),
        ...
        'plmapp.invitation': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 19, 14, 38, 0, 232056)'}),
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'4368504150627743859490756655100655420157962865064526557312079600770204373365552011151293280765385503683198376181285638885482663552630802299664966702010828'", 'max_length': '155', 'primary_key': 'True'}),
        ...
        'plmapp.plmobject': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 19, 14, 38, 0, 230262)'}),
        ...
        'plmapp.statehistory': {
            ...
            'lifecycle': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plmapp.Lifecycle']"}),
            'plmobject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plmapp.PLMObject']"}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 19, 14, 38, 0, 233700)'}),
            'state': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plmapp.State']"}),
