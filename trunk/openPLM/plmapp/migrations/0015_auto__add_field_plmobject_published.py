...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PLMObject.published'
        db.add_column('plmapp_plmobject', 'published', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PLMObject.published'
        db.delete_column('plmapp_plmobject', 'published')
    ...
    models = {
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 4, 15, 25, 32, 528256)'}),
        ...
        'plmapp.invitation': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 4, 15, 25, 32, 530918)'}),
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'2600842977032271152850596989325257490471414851235997010910293208746267788897694119642515912652442319262269841951712435854477098730181084060301816062483423'", 'max_length': '155', 'primary_key': 'True'}),
        ...
        'plmapp.plmobject': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 4, 15, 25, 32, 526506)'}),
        ...
        'plmapp.statehistory': {
            ...
            'lifecycle': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plmapp.Lifecycle']"}),
            'plmobject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plmapp.PLMObject']"}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 4, 15, 25, 32, 524345)'}),
            'state': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plmapp.State']"}),
