...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PLMObject.group'
        db.alter_column('plmapp_plmobject', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['plmapp.GroupInfo']))
    
    
    def backwards(self, orm):
        
        # Changing field 'PLMObject.group'
        db.alter_column('plmapp_plmobject', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group']))
    ...
    models = {
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 3, 9, 55, 6, 793315)'}),
        ...
        'plmapp.plmobject': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 3, 9, 55, 6, 728696)'}),
