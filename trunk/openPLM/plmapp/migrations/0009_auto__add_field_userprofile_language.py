...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('plmapp_userprofile', 'language', self.gf('django.db.models.fields.CharField')(default='en', max_length=5), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.language'
        db.delete_column('plmapp_userprofile', 'language')
    ...
    models = {
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 15, 15, 12, 8, 534650)'}),
        ...
        'plmapp.invitation': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 15, 15, 12, 8, 566825)'}),
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'8806052551503362641434617161665205394194854205207788583834361949623488318806247569186076601454048768105223191524030651576126097563538353111397706785815923'", 'max_length': '155', 'primary_key': 'True'}),
        ...
        'plmapp.plmobject': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 15, 15, 12, 8, 569548)'}),
