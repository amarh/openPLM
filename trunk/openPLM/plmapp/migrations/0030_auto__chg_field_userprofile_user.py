...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'plmapp_userprofile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.user'
        db.alter_column(u'plmapp_userprofile', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True))
    ...
    models = {
        ...
        'plmapp.invitation': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'2642125146995136678843163397521518770880283001137893203779445473302775369511821126311807301975442262338335890870582697859622176378768805858831956469548002'", 'max_length': '155', 'primary_key': 'True'}),
        ...
        'plmapp.synchronizedpartset': {
            'Meta': {'object_name': 'SynchronizedPartSet'},
            'ctime': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parts': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'synchronizedpartsets'", 'symmetrical': 'False', 'to': "orm['plmapp.Part']"})
        },
        'plmapp.userhistory': {
