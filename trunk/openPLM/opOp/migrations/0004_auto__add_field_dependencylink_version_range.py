...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DependencyLink.version_range'
        db.add_column('opOp_dependencylink', 'version_range', self.gf('django.db.models.fields.CharField')(default=' ', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DependencyLink.version_range'
        db.delete_column('opOp_dependencylink', 'version_range')
    ...
    models = {
        ...
        'opOp.dependencylink': {
            ...
            'version_range': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        'opOp.documentation': {
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 25, 17, 16, 15, 329798)'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
        ...
        'plmapp.plmobject': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 25, 17, 16, 15, 330768)'}),
