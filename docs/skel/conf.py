# -*- coding: utf-8 -*-
#
# openPLM documentation build configuration file, created by
...
project = u'openPLM'
copyright = u'2010-2012, LinObject'
...
modindex_common_prefix = ['openPLM.plmapp.', 'plmapp.']
...
# of the sidebar.
html_logo = "../../openPLM/media/img/dark/logo_openplm.png"

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = "../../openPLM/media/img/favicon.ico"
...
html_sidebars = {
   '**': ['localtoc.html','relations.html', 'sourcelink.html', 'searchbox.html', 'lang.html'],
}
