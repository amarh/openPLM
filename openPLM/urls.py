...
urlpatterns = patterns('',
    ...
    (r'^object/([^/]+)/([^/]+)/([^/]+)/navigate/(\-*\d+)/(\-*\d+)/(\d+)/$', navigate),
    (r'^object/([^/]+)/([^/]+)/([^/]+)/navigate/(\-*\d+)/(\-*\d+)/(\d+)/left/$', navigate_toward, {'direction': 'left'}),
    (r'^object/([^/]+)/([^/]+)/([^/]+)/navigate/(\-*\d+)/(\-*\d+)/(\d+)/right/$', navigate_toward, {'direction': 'right'}),
    (r'^object/([^/]+)/([^/]+)/([^/]+)/navigate/(\-*\d+)/(\-*\d+)/(\d+)/top/$', navigate_toward, {'direction': 'top'}),
    (r'^object/([^/]+)/([^/]+)/([^/]+)/navigate/(\-*\d+)/(\-*\d+)/(\d+)/bottom/$', navigate_toward, {'direction': 'bottom'}),
    (r'^object/([^/]+)/([^/]+)/([^/]+)/navigate/(\-*\d+)/(\-*\d+)/(\d+)/zoom-in/$', navigate_toward, {'direction': 'zoom-in'}),
    (r'^object/([^/]+)/([^/]+)/([^/]+)/navigate/(\-*\d+)/(\-*\d+)/(\d+)/zoom-out/$', navigate_toward, {'direction': 'zoom-out'}),
