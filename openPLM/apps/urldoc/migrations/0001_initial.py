...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'URLDoc'
        db.create_table('urldoc_urldoc', (
            ('document_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['plmapp.Document'], unique=True, primary_key=True)),
            ('location_uri', self.gf('django.db.models.fields.CharField')(default=' ', max_length=250, blank=True)),
        ))
        db.send_create_signal('urldoc', ['URLDoc'])


    def backwards(self, orm):
        
        # Deleting model 'URLDoc'
        db.delete_table('urldoc_urldoc')
    ...
    models = {
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 26, 11, 40, 27, 285029)'}),
        ...
        'plmapp.plmobject': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 26, 11, 40, 27, 285728)'}),
        ...
        'urldoc.urldoc': {
            ...
            'location_uri': ('django.db.models.fields.CharField', [], {'default': "' '", 'max_length': '250', 'blank': 'True'})
        }
    }

    complete_apps = ['urldoc']
