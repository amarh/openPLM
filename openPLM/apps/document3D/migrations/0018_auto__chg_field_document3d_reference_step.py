...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Document3D.reference_step'
        db.alter_column('document3D_document3d', 'reference_step_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['plmapp.DocumentFile'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Document3D.reference_step'
        db.alter_column('document3D_document3d', 'reference_step_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['plmapp.DocumentFile']))
    ...
    models = {
        ...
        'document3D.document3d': {
            ...
            'reference_step': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plmapp.DocumentFile']", 'null': 'True'})
        },
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 22, 14, 15, 28, 548064)'}),
        ...
        'plmapp.plmobject': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 22, 14, 15, 28, 554279)'}),
