...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'step_original'
        db.delete_table('document3D_step_original')

        # Adding model 'step_originallll'
        db.create_table('document3D_step_originallll', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('reference_step', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['plmapp.DocumentFile'])),
            ('reference_Document3D', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['plmapp.Document'])),
        ))
        db.send_create_signal('document3D', ['step_originallll'])


    def backwards(self, orm):
        
        # Adding model 'step_original'
        db.create_table('document3D_step_original', (
            ('reference_Document3D', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['plmapp.Document'])),
            ('reference_step', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['plmapp.DocumentFile'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('document3D', ['step_original'])

        # Deleting model 'step_originallll'
        db.delete_table('document3D_step_originallll')
    ...
    models = {
        ...
        'document3D.step_originallll': {
            'Meta': {'object_name': 'step_originallll'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'reference_Document3D': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plmapp.Document']"}),
            'reference_step': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plmapp.DocumentFile']"})
        },
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 7, 12, 42, 0, 238894)'}),
        ...
        'plmapp.plmobject': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 7, 12, 42, 0, 242262)'}),
