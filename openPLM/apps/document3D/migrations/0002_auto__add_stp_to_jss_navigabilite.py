...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'stp_to_jss_navigabilite'
        db.create_table('document3D_stp_to_jss_navigabilite', (
        ...
        db.send_create_signal('document3D', ['stp_to_jss_navigabilite'])


    def backwards(self, orm):
        
        # Deleting model 'stp_to_jss_navigabilite'
        db.delete_table('document3D_stp_to_jss_navigabilite')
    ...
    models = {
        ...
        'document3D.stp_to_jss_navigabilite': {
            'Meta': {'object_name': 'stp_to_jss_navigabilite'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'js': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'stp': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plmapp.DocumentFile']"})
        },
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 2, 16, 21, 42, 945813)'}),
        ...
        'plmapp.plmobject': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 2, 16, 21, 42, 938759)'}),
