...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for tree in orm.ArbreFile.objects.all():
            try:
                tree.file.storage = storage
                tree.decomposable = len(json.loads(tree.file.read())) > 1
            except Exception as e:
                tree.decomposable = False
            tree.save()
    ...
    models = {
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 28, 18, 53, 41, 489224)'}),
        ...
        'plmapp.plmobject': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 28, 18, 53, 41, 493224)'}),
