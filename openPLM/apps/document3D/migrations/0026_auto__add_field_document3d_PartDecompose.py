...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Document3D.PartDecompose'
        db.add_column('document3D_document3d', 'PartDecompose', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['plmapp.Part'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Document3D.PartDecompose'
        db.delete_column('document3D_document3d', 'PartDecompose_id')
    ...
    models = {
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 9, 11, 6, 54, 155283)'}),
        ...
        'plmapp.plmobject': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 9, 11, 6, 54, 149966)'}),
