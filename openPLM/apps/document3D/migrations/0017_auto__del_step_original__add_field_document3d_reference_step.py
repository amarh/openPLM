...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Document3D.reference_step'
        db.add_column('document3D_document3d', 'reference_step', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['plmapp.DocumentFile']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Document3D.reference_step'
        db.delete_column('document3D_document3d', 'reference_step_id')
    ...
    models = {
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 22, 14, 10, 19, 948314)'}),
        ...
        'plmapp.plmobject': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 22, 14, 10, 19, 959397)'}),
