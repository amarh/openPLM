...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('document3D_document3d', 'step_original', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['plmapp.DocumentFile'], null=True), keep_default=False)
    ...
    models = {
        ...
        'document3D.document3d': {
            ...
            'step_original': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plmapp.DocumentFile']", 'null': 'True'})
        },
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 7, 12, 10, 46, 411555)'}),
        ...
        'plmapp.plmobject': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 7, 12, 10, 46, 414248)'}),
