...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('document3D_document3d', 'step_active', self.gf('django.db.models.fields.related.ForeignKey')(related_name='step_active', null=True, to=orm['plmapp.DocumentFile']), keep_default=False)

        # Adding field 'Document3D.step_decompose'
        db.add_column('document3D_document3d', 'step_decompose', self.gf('django.db.models.fields.related.ForeignKey')(related_name='step_decompose', null=True, to=orm['plmapp.DocumentFile']), keep_default=False)
    ...
    models = {
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 27, 10, 3, 49, 603298)'}),
        ...
        'plmapp.plmobject': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 27, 10, 3, 49, 604213)'}),
