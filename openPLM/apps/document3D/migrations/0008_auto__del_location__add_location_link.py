...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('document3D_location')

        # Adding model 'Location_link'
        db.create_table('document3D_location_link', (
            ...
            ('z', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('rx', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('ry', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('rz', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('angle', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('name_reference', self.gf('django.db.models.fields.CharField')(default='no_name', max_length=100)),
        ))
        db.send_create_signal('document3D', ['Location_link'])


    def backwards(self, orm):
        
        # Adding model 'Location'
        db.create_table('document3D_location', (
            ('angle', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('y', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('x', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('parentchildlinkextension_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['plmapp.ParentChildLinkExtension'], unique=True, primary_key=True)),
        ...
        db.send_create_signal('document3D', ['Location'])

        # Deleting model 'Location_link'
        db.delete_table('document3D_location_link')
    ...
    models = {
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 31, 10, 50, 11, 854418)'}),
        ...
        'plmapp.plmobject': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 31, 10, 50, 11, 857121)'}),
