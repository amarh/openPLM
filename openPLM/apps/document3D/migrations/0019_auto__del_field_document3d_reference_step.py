...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('document3D_document3d', 'reference_step', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['plmapp.DocumentFile'], null=True), keep_default=False)
    ...
    models = {
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 22, 14, 24, 45, 629808)'}),
        ...
        'plmapp.plmobject': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 22, 14, 24, 45, 633120)'}),
