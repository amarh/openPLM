...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OfficeDocument'
        db.create_table('office_officedocument', (
        ...
        db.send_create_signal('office', ['OfficeDocument'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'OfficeDocument'
        db.delete_table('office_officedocument')
    ...
    models = {
        ...
        'office.officedocument': {
            'Meta': {'object_name': 'OfficeDocument', '_ormbases': ['plmapp.Document']},
        ...
        'plmapp.plmobject': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 30, 16, 9, 14, 931181)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
