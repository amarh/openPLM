...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SubversionRepository'
        db.create_table('subversion_subversionrepository', (
            ('document_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['plmapp.Document'], unique=True, primary_key=True)),
            ('repository_uri', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('svn_revision', self.gf('django.db.models.fields.CharField')(default='HEAD', max_length=50)),
            ('issue_tracking_system', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
        ))
        db.send_create_signal('subversion', ['SubversionRepository'])


    def backwards(self, orm):
        
        # Deleting model 'SubversionRepository'
        db.delete_table('subversion_subversionrepository')
    ...
    models = {
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 25, 15, 58, 44, 344422)'}),
        ...
        'plmapp.plmobject': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 25, 15, 58, 44, 353431)'}),
        ...
        'subversion.subversionrepository': {
            'Meta': {'ordering': "['type', 'reference', 'revision']", 'object_name': 'SubversionRepository', '_ormbases': ['plmapp.Document']},
            'document_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['plmapp.Document']", 'unique': 'True', 'primary_key': 'True'}),
            'issue_tracking_system': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'}),
            'repository_uri': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            'svn_revision': ('django.db.models.fields.CharField', [], {'default': "'HEAD'", 'max_length': '50'})
        }
    }

    complete_apps = ['subversion']
