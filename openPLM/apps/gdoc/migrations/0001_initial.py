...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('gdoc_flowmodel', (
            ('id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], primary_key=True)),
            ('flow', self.gf('oauth2client.django_orm.FlowField')()),
        ))
        db.send_create_signal('gdoc', ['FlowModel'])

        # Adding model 'CredentialsModel'
        db.create_table('gdoc_credentialsmodel', (
            ('id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], primary_key=True)),
            ('credential', self.gf('oauth2client.django_orm.CredentialsField')()),
        ))
        db.send_create_signal('gdoc', ['CredentialsModel'])


    def backwards(self, orm):
        
        # Deleting model 'FlowModel'
        db.delete_table('gdoc_flowmodel')

        # Deleting model 'CredentialsModel'
        db.delete_table('gdoc_credentialsmodel')
