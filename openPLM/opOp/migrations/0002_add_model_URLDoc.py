...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 22, 16, 19, 13, 567850)'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
        ...
        'plmapp.plmobject': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 22, 16, 19, 13, 566913)'}),
