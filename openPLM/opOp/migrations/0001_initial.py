...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('opOp', ['Package'])

        # Adding model 'Software'
        db.create_table('opOp_software', (
            ('part_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['plmapp.Part'], unique=True, primary_key=True)),
            ...
            ('bugtracker_uri', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ))
        db.send_create_signal('opOp', ['Software'])

        # Adding model 'Documentation'
        db.create_table('opOp_documentation', (
            ('part_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['plmapp.Part'], unique=True, primary_key=True)),
            ('doc_uri', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ))
        db.send_create_signal('opOp', ['Documentation'])

        # Adding model 'Specification'
        db.create_table('opOp_specification', (
            ('document_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['plmapp.Document'], unique=True, primary_key=True)),
            ('spec_uri', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ))
        db.send_create_signal('opOp', ['Specification'])

        # Adding model 'DependencyLink'
        db.create_table('opOp_dependencylink', (
        ...
        db.send_create_signal('opOp', ['DependencyLink'])


    def backwards(self, orm):
        
        # Deleting model 'Package'
        db.delete_table('opOp_package')

        # Deleting model 'Software'
        db.delete_table('opOp_software')

        # Deleting model 'Documentation'
        db.delete_table('opOp_documentation')

        # Deleting model 'Specification'
        db.delete_table('opOp_specification')

        # Deleting model 'DependencyLink'
        db.delete_table('opOp_dependencylink')
    ...
    models = {
        ...
        'opOp.documentation': {
            'Meta': {'ordering': "['type', 'reference', 'revision']", 'object_name': 'Documentation', '_ormbases': ['plmapp.Part']},
            'doc_uri': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
        ...
        'opOp.software': {
            ...
            'bugtracker_uri': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
        ...
        'opOp.specification': {
            'Meta': {'ordering': "['type', 'reference', 'revision']", 'object_name': 'Specification', '_ormbases': ['plmapp.Document']},
            'document_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['plmapp.Document']", 'unique': 'True', 'primary_key': 'True'}),
            'spec_uri': ('django.db.models.fields.CharField', [], {'max_length': '250'})
        },
        'plmapp.document': {
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 21, 16, 45, 48, 239609)'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
        ...
        'plmapp.plmobject': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 21, 16, 45, 48, 241210)'}),
