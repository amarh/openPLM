...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'URLDoc.location_uri'
        db.add_column('opOp_urldoc', 'location_uri', self.gf('django.db.models.fields.CharField')(default=' ', max_length=250), keep_default=False)

        # Deleting field 'Documentation.doc_uri'
        db.delete_column('opOp_documentation', 'doc_uri')


    def backwards(self, orm):
        
        # Deleting field 'URLDoc.location_uri'
        db.delete_column('opOp_urldoc', 'location_uri')

        # Adding field 'Documentation.doc_uri'
        db.add_column('opOp_documentation', 'doc_uri', self.gf('django.db.models.fields.CharField')(default=' ', max_length=250), keep_default=False)
    ...
    models = {
        ...
        'opOp.urldoc': {
            'Meta': {'ordering': "['type', 'reference', 'revision']", 'object_name': 'URLDoc', '_ormbases': ['plmapp.Document']},
            'document_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['plmapp.Document']", 'unique': 'True', 'primary_key': 'True'}),
            'location_uri': ('django.db.models.fields.CharField', [], {'default': "' '", 'max_length': '250'})
        },
        'plmapp.document': {
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 25, 9, 36, 6, 402340)'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
        ...
        'plmapp.plmobject': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 25, 9, 36, 6, 403043)'}),
