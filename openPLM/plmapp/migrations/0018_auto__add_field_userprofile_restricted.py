...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.restricted'
        db.add_column('plmapp_userprofile', 'restricted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.restricted'
        db.delete_column('plmapp_userprofile', 'restricted')
    ...
    models = {
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 12, 10, 0, 6, 814603)'}),
        ...
        'plmapp.invitation': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 12, 10, 0, 6, 818447)'}),
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'9193406891057684070610224568747006382428646077312117188276400350648508712445300535780798441404573393459124260372069872431924699841384515230696876774675156'", 'max_length': '155', 'primary_key': 'True'}),
        ...
        'plmapp.plmobject': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 12, 10, 0, 6, 821124)'}),
        ...
        'plmapp.statehistory': {
            ...
            'lifecycle': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plmapp.Lifecycle']"}),
            'plmobject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plmapp.PLMObject']"}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 12, 10, 0, 6, 820088)'}),
            'state': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plmapp.State']"}),
