...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ParentChildLink.unit'
        db.add_column('plmapp_parentchildlink', 'unit', self.gf('django.db.models.fields.CharField')(default='-', max_length=4), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ParentChildLink.unit'
        db.delete_column('plmapp_parentchildlink', 'unit')
    ...
    models = {
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 16, 12, 57, 44, 394109)'}),
        ...
        'plmapp.invitation': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 16, 12, 57, 44, 414560)'}),
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'3861003642444530975588900629954848706284610989089605860787476037557906855161936584956441454448255873324723321601037611665542233728506439389055571687937231'", 'max_length': '155', 'primary_key': 'True'}),
        ...
        'plmapp.plmobject': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 16, 12, 57, 44, 451382)'}),
