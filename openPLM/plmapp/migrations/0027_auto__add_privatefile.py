...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('plmapp_privatefile', (
    ...
    def backwards(self, orm):
        ...
        db.delete_table('plmapp_privatefile')
    ...
    models = {
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 20, 0, 0)'}),
        ...
        'plmapp.invitation': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'9638476987279206196045068896222998235707369842430793787718950346562006740332437375815791682622263338570358201175009665420884930153146852499533163186988921'", 'max_length': '155', 'primary_key': 'True'}),
        ...
        'plmapp.statehistory': {
            ...
            'lifecycle': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plmapp.Lifecycle']"}),
            'plmobject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plmapp.PLMObject']"}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 20, 0, 0)'}),
            'state': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plmapp.State']"}),
