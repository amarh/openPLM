...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DocumentFile.ctime'
        db.add_column('plmapp_documentfile', 'ctime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.utcnow), keep_default=False)

        # Adding field 'DocumentFile.end_time'
        db.add_column('plmapp_documentfile', 'end_time', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'DocumentFile.deleted'
        db.add_column('plmapp_documentfile', 'deleted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'DocumentFile.revision'
        db.add_column('plmapp_documentfile', 'revision', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'DocumentFile.previous_revision'
        db.add_column('plmapp_documentfile', 'previous_revision', self.gf('django.db.models.fields.related.OneToOneField')(default=None, related_name='next_revision', unique=True, null=True, to=orm['plmapp.DocumentFile']), keep_default=False)

        # Adding field 'DocumentFile.last_revision'
        db.add_column('plmapp_documentfile', 'last_revision', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='older_files', null=True, to=orm['plmapp.DocumentFile']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DocumentFile.ctime'
        db.delete_column('plmapp_documentfile', 'ctime')

        # Deleting field 'DocumentFile.end_time'
        db.delete_column('plmapp_documentfile', 'end_time')

        # Deleting field 'DocumentFile.deleted'
        db.delete_column('plmapp_documentfile', 'deleted')

        # Deleting field 'DocumentFile.revision'
        db.delete_column('plmapp_documentfile', 'revision')

        # Deleting field 'DocumentFile.previous_revision'
        db.delete_column('plmapp_documentfile', 'previous_revision_id')

        # Deleting field 'DocumentFile.last_revision'
        db.delete_column('plmapp_documentfile', 'last_revision_id')
    ...
    models = {
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 14, 11, 49, 57, 961145)'}),
        ...
        'plmapp.invitation': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 14, 11, 49, 57, 963970)'}),
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'8564507215721919831720321108363117117907556481806939286481404151553088152127709653483291386215920302224615058627339391756168791553062019326166699933648157'", 'max_length': '155', 'primary_key': 'True'}),
        ...
        'plmapp.plmobject': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 14, 11, 49, 57, 953885)'}),
        ...
        'plmapp.statehistory': {
            ...
            'lifecycle': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plmapp.Lifecycle']"}),
            'plmobject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plmapp.PLMObject']"}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 14, 11, 49, 57, 964608)'}),
            'state': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plmapp.State']"}),
