...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PLMObject.description'
        db.add_column(u'plmapp_plmobject', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PLMObject.description'
        db.delete_column(u'plmapp_plmobject', 'description')
    ...
    models = {
        ...
        'plmapp.invitation': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'2098055910540360751956109437215401568566302521074655303697153773195508654355867717890766312053089946976334230398897001291979695918452870831895562170556431'", 'max_length': '155', 'primary_key': 'True'}),
