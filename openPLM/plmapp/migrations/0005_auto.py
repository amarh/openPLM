...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'PLMObject', fields ['reference']
        db.create_index('plmapp_plmobject', ['reference'])

        # Adding index on 'PLMObjectUserLink', fields ['role']
        db.create_index('plmapp_plmobjectuserlink', ['role'])

        # Adding index on 'DelegationLink', fields ['role']
        db.create_index('plmapp_delegationlink', ['role'])


    def backwards(self, orm):
        
        # Removing index on 'DelegationLink', fields ['role']
        db.delete_index('plmapp_delegationlink', ['role'])

        # Removing index on 'PLMObjectUserLink', fields ['role']
        db.delete_index('plmapp_plmobjectuserlink', ['role'])

        # Removing index on 'PLMObject', fields ['reference']
        db.delete_index('plmapp_plmobject', ['reference'])
    ...
    models = {
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 6, 15, 26, 52, 852923)'}),
        ...
        'plmapp.invitation': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 6, 15, 26, 52, 856142)'}),
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'8696772256933239912406845880121995163669400296844007281790358315690088493453445789587455385106297863670173955736565452264388356878281071529838911021995850'", 'max_length': '155', 'primary_key': 'True'}),
        ...
        'plmapp.plmobject': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 6, 15, 26, 52, 840630)'}),
