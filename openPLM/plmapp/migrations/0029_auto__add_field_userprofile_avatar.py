...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'plmapp_userprofile', 'avatar',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'plmapp_userprofile', 'avatar')
    ...
    models = {
        ...
        'plmapp.invitation': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'8195106274446493012892979807277500705020243298201109727132342568224434969071409398873377419921364953784612065073485319222814613723793902381928361934646591'", 'max_length': '155', 'primary_key': 'True'}),
