...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for path in orm.DocumentFile.objects.filter(document__published=True).exclude(thumbnail="").values_list("thumbnail", flat=True):
            try:
                os.symlink(os.path.join(input_dir, path),
                       os.path.join(output_dir, path))
            except OSError as e:
                print "Warning: Error while creating symlink for %s:%s" % (path, str(e))
    ...
    def backwards(self, orm):
        ...
        for path in orm.DocumentFile.objects.filter(document__published=True).exclude(thumbnail="").values_list("thumbnail", flat=True):
            try:
                ...
                print "Warning: Error while deleting symlink for %s:%s" % (path, str(e))
    ...
    models = {
        ...
        'plmapp.groupinfo': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 23, 16, 32, 14, 259839)'}),
        ...
        'plmapp.invitation': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 23, 16, 32, 14, 260349)'}),
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'5074234248094336056651819305383754459138034168385190776308903323630851199159170439905976719391340831161884957121994416458249724406149885639591605706416127'", 'max_length': '155', 'primary_key': 'True'}),
        ...
        'plmapp.plmobject': {
            ...
            'ctime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 23, 16, 32, 14, 272206)'}),
        ...
        'plmapp.statehistory': {
            ...
            'lifecycle': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plmapp.Lifecycle']"}),
            'plmobject': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plmapp.PLMObject']"}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 23, 16, 32, 14, 275419)'}),
            'state': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plmapp.State']"}),
